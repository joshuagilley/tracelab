// Runnable demo — mirrors concepts/dependency-injection/present.go (self-contained for go run).
//
//	go run .
//
// Or from labs/design-patterns: go run ./concepts/dependency-injection/demo
package main
