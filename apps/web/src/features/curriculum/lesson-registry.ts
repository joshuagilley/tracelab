 ...
 * Used by LessonPage to render the left-column lesson content for any
...
export const LESSON_REGISTRY: Record<string, ComponentType<LessonPanelProps>> = {
  ...
  /** Main System Design topic; text panel when vizType is lesson/empty (sim uses vizType `load-balancer`). */
  'load-balancing': LoadBalancerLesson,
