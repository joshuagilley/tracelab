  ...
  if (!ready) {
    return (
      <div style={{ padding: '2rem', maxWidth: 480, fontFamily: 'system-ui, sans-serif', color: '#a8b0c4' }}>
        <p style={{ margin: 0, fontSize: '1.05rem' }}>Loading curriculum…</p>
        {slowHint ? (
          <p style={{ margin: '0.75rem 0 0', fontSize: '0.9rem', lineHeight: 1.45, opacity: 0.92 }}>
            Still working — on hosted APIs (e.g. Google Cloud Run) the first request after idle can take several
            seconds while the service cold-starts. This is normal.
          </p>
        ) : null}
      </div>
    )
